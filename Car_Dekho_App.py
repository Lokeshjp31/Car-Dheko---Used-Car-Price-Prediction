...
model = joblib.load('D:\GUVI_Data_Science_Projects\CarDekho_Project\car_price_prediction_Final_model.pkl')
label_encoders = joblib.load('D:\GUVI_Data_Science_Projects\CarDekho_Project\label_encoders.pkl')
scalers = joblib.load('D:\GUVI_Data_Science_Projects\CarDekho_Project\scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv('D:\GUVI_Data_Science_Projects\CarDekho_Project\car_dekho_cleaned_dataset_Raw.csv')
...
logo = "D:\GUVI_Data_Science_Projects\CarDekho_Project\Car_dekho_logo.png"
st.header("Get accurate car valuations instantly", divider="gray")
st.sidebar.image(logo, caption='Car Price Estimator', use_column_width=True)

# Sidebar for user inputs
st.sidebar.header('Lets Predict')

# Set background colors
input_background_color = "black"  # Light maroon color
result_background_color = "#E2D6D6"  # Cosmic latte or beige color
...
selected_oem = visual_selectbox('1. Car Brand/Manufacturer (OEM)', data['oem'].unique())
